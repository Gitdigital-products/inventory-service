# Inventory Service (Teacher + Students)

This microservice manages inventory data inside the Gitdigital ecosystem.  
It also acts as a **Teacher Agent**, training and supervising smaller **Student Agents** that handle specific tasks.

---

## 🌱 Purpose

The service owns all logic for:
- Tracking items
- Updating quantities
- Syncing inventory states between other GDHQ microservices

It teaches Student Agents how to perform narrow tasks without slowing down the main service.
